...
private:
         ...
         */
        void parseRead(const FastQRecord& rr) const;

        /**
         * Entry routine for worker thread
         * @param myID Unique threadID // FIXME
         */
        void workerThread(FastQReader& inputs);
public:
        /**
         * Default constructor
         ...
         * @param filename Filename for the de Bruijn graph
         */
        void extractNodes(const std::string& filename);
